(function ($, Drupal, once) {
  Drupal.behaviors.WebShare = {
    attach(context, settings) {
      $(once('webshare-activate', context)).click(function (e) {
        const links = $(this).parent().parent().find('.webshare-links');
        $(links).toggleClass('webshare-active');
        $(links).toggleClass('webshare-inactive');
        e.stopPropagation();
      });
      $(once('webshare-deactivate', context)).click(function () {
      ...
      $(once('webshare-copy-url', '.webshare-copy-url', context)).click(
        function (e) {
          e.preventDefault();
          const url = $(this).data('clipboard') || window.location.href;
      ...
      $(once('webshare-link-copy', '.webshare-link.copy', context)).click(
        function () {
