...
class VariableAnalysisSniff implements Sniff {
  ...
  /**
   * @var \VariableAnalysis\Lib\ScopeManager
   */
   ...
   * @param int $currScope
   *
   * @return \VariableAnalysis\Lib\ScopeInfo
   */
   ...
   * @param int $currScope
   *
   * @return \VariableAnalysis\Lib\VariableInfo|null
   */
   ...
   * @param int $currScope
   *
   * @return \VariableAnalysis\Lib\VariableInfo
   */
   ...
   *
   * @param string $varName
   * @param \VariableAnalysis\Lib\ScopeType::PARAM|ScopeType::BOUND|ScopeType::LOCAL|ScopeType::GLOBALSCOPE|ScopeType::STATICSCOPE $scopeType
   ...
   * @param string $varName
   * @param int $outerScope
   *   The start of the scope outside the function definition
   *
   * @return void
   */
   ...
   *   The PHP_CodeSniffer file where this token was found.
   * @param int $stackPtr
   *   The position where the call to compact() was found.
   *
   * @return void
   */
   ...
   *   The PHP_CodeSniffer file where this token was found.
   * @param int $stackPtr
   *   The position of the scope conditional.
   *
   * @return void
   */
   ...
   *
   * @param \PHP_CodeSniffer\Files\File $phpcsFile
   * @param \VariableAnalysis\Lib\VariableInfo $varInfo
   * @param \VariableAnalysis\Lib\ScopeInfo $scopeInfo
   *
   * @return void
   */
