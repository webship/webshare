...
class Helpers {
   ...
   * @param int $stackPtr
   * @param string $varName
   *   (optional) if it differs from the normalized 'content' of the token at $stackPtr
   *
   * @return ?int
   */
   ...
   * @param \PHP_CodeSniffer\Files\File $phpcsFile
   * @param int $stackPtr
   * @param array<int, array<int>> $arguments
   *   The stack pointers of each argument; see findFunctionCallArguments
   *
   ...
   * @param int $stackPtr
   *
   * @return \VariableAnalysis\Lib\EnumInfo|null
   */
   ...
   * @param int $stackPtr
   *
   * @return \VariableAnalysis\Lib\ForLoopInfo
   */
   ...
   * @return \VariableAnalysis\Lib\ForLoopInfo|null
   */
   ...
   * @param \PHP_CodeSniffer\Files\File $phpcsFile
   * @param int $stackPtr
   *   The index of the function keyword.
   *
   * @return bool
   */
