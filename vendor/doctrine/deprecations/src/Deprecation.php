...
class Deprecation {
  ...
  public static function trigger(string $package, string $link, string $message, ...$args): void {
    ...
    $backtrace = debug_backtrace(\const, 2);
  ...
  public static function triggerIfCalledFromOutside(string $package, string $link, string $message, ...$args): void {
    ...
    if (isset($backtrace[1]['file'], $backtrace[0]['file']) && strpos($backtrace[1]['file'], \const . 'tests' . \const) === FALSE) {
      $path = \const . 'vendor' . \const . str_replace('/', \const, $package) . \const;
