...
class Environment {
   ...
   *
   * @return \Twig\Cache\CacheInterface|string|false A Twig\Cache\CacheInterface implementation,
   ...
   *
   * @param \Twig\Cache\CacheInterface|string|false $cache
   *   A Twig\Cache\CacheInterface implementation,
   *   an absolute path to the compiled templates,
   *                                           or false to disable cache
   *
   ...
   *
   * @param string|TemplateWrapper|array<string|TemplateWrapper> $names
  ...
  /**
   * @return \Twig\Node\NodeVisitorInterface[]
   *
   * @internal
   */
