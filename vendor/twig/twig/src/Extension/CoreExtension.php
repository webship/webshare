...
final class CoreExtension extends AbstractExtension {
   ...
   *   The position of the value to return in the cycle
   *
   ...
   *
   * @param \DateTimeInterface|\DateInterval|string|int|null $date
   ...
   * @param 'common'|'ceil'|'floor' $method
   ...
   *   Any number of arrays or Traversable objects to merge
   *
   * @internal
   */
   ...
   *  {# returns 123 #}
   *
   * @param iterable|array|string|float|int|bool|null $value
   *   An array
   * @param string $glue
   *   The separator
  ...
  /**
   * @throws \Twig\Error\RuntimeError When an invalid pattern is used
   *
   * @internal
   */
   ...
   *   left, right, or both
   *
   * @throws \Twig\Error\RuntimeError When an invalid trimming side is used
   *
   * @internal
   */
   ...
   *
   * @param array $context
   * @param string|array|TemplateWrapper $template
   ...
   * @param bool $checkDefined
   *   Whether to check if the constant is defined or not
   *
   ...
   * @param string $type
   *   The type of attribute (@see \Twig\Template constants)
   ...
   * @param int $lineno
   *   The template line where the attribute was called
   *
